...
var padesPolicies = map[signaturepolicy.PolicyName]PolicyInfo{
	...
	PolicyNamePAADRA: {
		policyBase: policyBase{
			OID: asn1.ObjectIdentifier{2, 16, 76, 1, 7, 1, 14, 1, 4},
			Hash: []byte{
				0xff, 0xa9, 0xfd, 0x47, 0x48, 0x12, 0xf6, 0xce,
				0x63, 0xd6, 0x25, 0x67, 0x9c, 0x9e, 0xf2, 0x35,
				0xa6, 0x54, 0x7b, 0x01, 0x7b, 0xe9, 0x41, 0xb2,
				0xc0, 0x94, 0xaa, 0x86, 0x8e, 0x67, 0xe1, 0x23,
			},
